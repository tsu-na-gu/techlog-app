ActiveAdmin.setup do |config|
  ...
  #
  config.site_title = "Support Board"
  ...
  # within the application contr  config.authentication_method = :custom_admin_authenticationoller.
  ...
  # config.session_store :cookie_store, key: '_your_admin_app_session'
  #config.authentication_method = :custom_admin_authentication
